...
struct BSDF {
    ...
    // Sample the BSDF
    HD static Color3f sample(const Material& mat, const SurfaceIntersection& si, BSDFSample& bs, const Point2f& s2) {
        bs.wi = si.to_local(si.wi);
        bs.front_face = si.front_face;
        
        Color3f albedo = get_albedo(mat, si);
    ...
    HD static void eval_pdf(const Material& mat, const SurfaceIntersection& si, const Vector3f& wo_local,
